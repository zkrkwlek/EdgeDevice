...
public class VirtualObject : MonoBehaviour
{
    ...
    public void SetMatrix4x4(Matrix4x4 localToWorldMatrix)
    {
        ...
        SetPose(targetPosition, targetRotation, previousPosition, previousRotation);
    }

    public void SetPose(Vector3 targetPosition, Quaternion targetRotation, Vector3 previousPosition, Quaternion previousRotation)
    {
        if (!smoothing)
        {
